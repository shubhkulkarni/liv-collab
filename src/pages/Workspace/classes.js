export const classes = {
  home: ` flex  flex-col items-center justify-start w-full h-full`,
  logo: `self-start lg:ml-8 mt-6 flex items-center`,
  joinCtr: `px-6 bg-white py-16 md:mt-38 mt-20 w-full flex flex-col  items-center justify-center`,
  joinBtn: `transition-all duration-500 transform hover:scale-105 focus:outline-none bg-white 
  ...
  editor: `w-full h-full md:pl-8 px-4 md:mt-0 mt-8 flex justify-center `,
